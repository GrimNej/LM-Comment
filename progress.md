...
- Opening-duration update: commit `b0e0ae4` reduces the presenter hook to 28 words, about 10 to 13 seconds at a natural pace. `pnpm check:copy` and `git diff --check` passed; no application code, time cue, or video artifact changed.
